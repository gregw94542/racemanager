...
<?php
	...
	$query = "insert into races(race_name, race_location, race_date, race_enable, preliminary, association_id) values ('$_POST[RACE_NAME]', 
	  '$_POST[RACE_LOCATION]',  '$race_date', 1, 1, '$_POST[ASSOCIATION_ID]')";
	#echo $query;
