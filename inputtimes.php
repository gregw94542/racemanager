...
function input_entry( $race_id,$division_id,$heatnum,$skate_id,$pos,
	  $min_raw,$sec_raw,$hun_raw,$place, $points,$notes, $bogusity)
{
		...
		$min = strip_leading_zeros($min_raw);
		$sec = strip_leading_zeros($sec_raw);
		$hun = strip_leading_zeros_hun($hun_raw);
...
echo "<META HTTP-EQUIV=\"Refresh\" 
	CONTENT=\"10; URL=DivisionEnterResults.php?RACE_ID=$RACE_ID&DIVISION_ID=$DIVISION_ID\">";
