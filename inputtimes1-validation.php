...
function add_entry($race_id, $division_id, $heatnum, $skate_id, $pos, $min, $sec, $hun, $place, $points, $notes, $bogusity)
{
  ...
  // Done futzing around with minutes
  if ($sec == NULL) {
	$sec = "0";
  }
...
echo "<META HTTP-EQUIV=\"Refresh\" 
	CONTENT=\"0; URL=resultentry-validation.php?RACE_ID=$RACE_ID\">";
echo "<a href=resultentry-validation.php?RACE_ID=$RACE_ID>Updating database.... Click this link in case the browser gets stuck here</a>";
?>
</body>
</html>
